...
class ProjectReporter(models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE, verbose_name='填报人员', db_constraint=False)
...
class MonthlyReport(models.Model):
    ...
    # 基础信息
    reporter = models.ForeignKey(User, on_delete=models.CASCADE, verbose_name='填报人', db_constraint=False)
    ...
    approver = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, blank=True, 
                                 related_name='approved_reports', verbose_name='审核人', db_constraint=False)
