...
class IndexView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['recent_cost_projects'] = cost_project_queryset.order_by('-created_at')[:5]
        
        # 获取造价咨询合同数据（应用租户过滤）
        cost_contract_queryset = contract_queryset.filter(contract_category='cost_consulting')
        context['recent_cost_contracts'] = cost_contract_queryset.order_by('-signing_time')[:5]
